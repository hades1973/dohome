...
\vspace{-0.8em} {\small 
\begin{align*}
	\alpha_s &= \frac{M}{\alpha_1 f_c b'_f h^2_0} = \frac{ {{printf "%4.1f" .M}}\times10^6 }{ 1.0\times {{.F_c}}\times {{.Bff}}\times {{.H_0}}^2 }={{printf "%5.3f" .Alpha_s}} \\
	\alpha_{s,max} &= \xi_b(1 - 0.5\xi_b)= {{.Xi_b}}\times (1 - 0.5\times {{.Xi_b}} ) = {{printf "%5.3f" .Alpha_smax}} \\
...
\begin{align*}
	A_s &= \frac{\alpha_1 f_c b'_f x}{f_y} \\
	    &= \frac{1.0\times {{.F_c}}\times {{.Bff}}\times {{printf "%4.1f" .X}} }{ {{.F_y}} } \\
